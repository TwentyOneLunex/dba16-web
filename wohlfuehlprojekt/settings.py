"""
Django settings for wohlfühlprojekt project.
...
#Build the Path to the Bootstrap3 Folder.
...
SECRET_KEY = 'xhr1*^j&qe#ee(98%v)til0fwir+jbzrk4d6tt10kx8p@pt_u8'
...
# Middleware - System for globally altering input and output.
MIDDLEWARE = [
